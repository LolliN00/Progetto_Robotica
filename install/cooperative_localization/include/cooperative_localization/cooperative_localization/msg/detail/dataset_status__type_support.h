...
#ifndef COOPERATIVE_LOCALIZATION__MSG__DETAIL__DATASET_STATUS__TYPE_SUPPORT_H_
#define COOPERATIVE_LOCALIZATION__MSG__DETAIL__DATASET_STATUS__TYPE_SUPPORT_H_
...
#endif  // COOPERATIVE_LOCALIZATION__MSG__DETAIL__DATASET_STATUS__TYPE_SUPPORT_H_
