...
#include "cooperative_localization/msg/detail/measurement__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cooperative_localization::msg::Measurement & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cooperative_localization::msg::Measurement & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cooperative_localization::msg::Measurement;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cooperative_localization::msg::Measurement *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cooperative_localization::msg::Measurement *>(
    untyped_ros_message);
...
{
  return &cooperative_localization::msg::typesupport_fastrtps_cpp::_Measurement__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cooperative_localization, msg, Measurement)() {
  return &cooperative_localization::msg::typesupport_fastrtps_cpp::_Measurement__handle;
}
