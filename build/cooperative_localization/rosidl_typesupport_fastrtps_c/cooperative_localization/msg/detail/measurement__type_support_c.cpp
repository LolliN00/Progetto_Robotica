...
#include "cooperative_localization/msg/detail/measurement__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_cooperative_localization
...
using _Measurement__ros_msg_type = cooperative_localization__msg__Measurement;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message->observer_id;
  }

  // Field name: subject_id
  {
    cdr << ros_message->subject_id;
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: observer_id
  {
    size_t item_size = sizeof(ros_message->observer_id);
  ...
  // Field name: subject_id
  {
    size_t item_size = sizeof(ros_message->subject_id);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cooperative_localization__msg__Measurement;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cooperative_localization__msg__Measurement * ros_message = static_cast<const cooperative_localization__msg__Measurement *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cooperative_localization__msg__Measurement(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cooperative_localization__msg__Measurement * ros_message = static_cast<cooperative_localization__msg__Measurement *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cooperative_localization__msg__Measurement(cdr, ros_message);
}

static uint32_t _Measurement__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cooperative_localization__msg__Measurement(
...
static size_t _Measurement__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cooperative_localization__msg__Measurement(
