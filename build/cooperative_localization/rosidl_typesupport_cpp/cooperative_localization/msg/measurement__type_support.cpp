...
static const _Measurement_type_support_symbol_names_t _Measurement_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cooperative_localization, msg, Measurement)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cooperative_localization, msg, Measurement)),
  }
};
...
{
  return &::cooperative_localization::msg::rosidl_typesupport_cpp::Measurement_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cooperative_localization, msg, Measurement)() {
  return get_message_type_support_handle<cooperative_localization::msg::Measurement>();
}
